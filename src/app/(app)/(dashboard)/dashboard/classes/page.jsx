...
export default function Classes() {
    const { userEnrollments } = useEnrollments()
    const userActiveReservedEnrollments = Array.isArray(userEnrollments)
        ...
        : []
    const userExpiredCanceledEnrollments = Array.isArray(userEnrollments)
        ? userEnrollments.filter(
              enrollment =>
