...
export default function Main() {
    ...
    return (
        <div className="w-full flex flex-col gap-6 mt-2">
            ...
            <div
                onClick={logout}
                className=" desktop:hidden flex items-center gap-2 text-error py-2 px-4 border border-error rounded-md w-fit hover:bg-error hover:text-bgPrimary transition-all">
                <Icons name="logout" />
