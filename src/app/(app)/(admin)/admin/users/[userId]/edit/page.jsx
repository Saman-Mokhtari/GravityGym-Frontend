...
export default function Main() {
    ...
    const { update, loading, user } = useUser()
    const roleOptions = [
        {
            value: 'athlete',
            label: 'ورزشکار',
    ...
    useEffect(() => {
        setTitle(`ویرایش اطلاعات ${userData?.name}`)
    }, [userData])
    useEffect(() => {
        if (params?.userId) {
    ...
    const notify = () =>
        toast.success('کاربر با موفقیت ویرایش شد!', { duration: 3000 })
    ...
    return (
        <div className="w-full flex flex-col gap-6">
            ...
            <FormLabel text="اطلاعات جدید کاربر را وارد کنید." />
