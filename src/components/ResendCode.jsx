            ...
            <div dir="rtl" className="flex items-center gap-4">
                {codeSent ? (
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <div
                            onClick={resendCodeHandler}
                            className={`text-textPrimary font-medium text-[16px] hover:text-textSecondary transition-all duration-50`}></div>
                        لطفا منتظر بمانید
                    </div>
                )}
                <p
                    className={`font-light text-[16px] text-success ${
                        newCodeCountDown === 0 && 'hidden'
                    }`}>
